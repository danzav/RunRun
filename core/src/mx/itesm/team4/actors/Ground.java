...
import mx.itesm.team4.box2d.GroundUserData;
...
public class Ground extends GameActor{
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(textureRegion, textureRegionBounds1.x, (float)screenRectangle.y, (float)screenRectangle.getWidth(),
                (float)screenRectangle.getHeight());
        batch.draw(textureRegion, textureRegionBounds2.x, (float)screenRectangle.y, (float)screenRectangle.getWidth(),
                (float)screenRectangle.getHeight());
    }
